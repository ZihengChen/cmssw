...
# with command line options: step4 --conditions auto:phase2_realistic -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry Extended2023D35 --era Phase2C4_timing_layer_bar --mc -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
